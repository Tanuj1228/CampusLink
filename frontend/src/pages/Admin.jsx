  ...
  return (
    <>
      <nav className="navbar admin-navbar">
        <Link to="/" className="logo">CampusLink Admin</Link>
        ...
        <div className="admin-main">
          ...
          <div className="stats-grid">
            ...
            <div className="stat-card">
              <p>Students</p>
              <h2>{analytics.totalStudents || 0}</h2>
            </div>

            <div className="stat-card">
              <p>Jobs</p>
              <h2>{analytics.totalJobs || 0}</h2>
            </div>

            <div className="stat-card">
              <p>Applications</p>
              <h2>{analytics.totalApplications || 0}</h2>
            </div>

            <div className="stat-card">
              <p>Hired</p>
              <h2>{analytics.totalHired || 0}</h2>
            </div>
          ...
          <div className="pending-section">
            ...
            <h3 className="pending-title">Pending Job Approvals</h3>

            {pendingJobs.length === 0 ? (
              <p className="empty-text">No pending jobs for approval.</p>
            ) : (
              pendingJobs.map(job => (
                <div key={job.id} className="pending-job">
                  ...
                  <a href={job.jd_link} target="_blank" className="jd-link">
                    View JD Link
                  </a>
